...
class CheckoutModel(models.Model):
    ...
    shippingmethods = models.CharField(max_length=100,choices=SHIPPINGOPTIONS)
    paymentmethods = models.CharField(max_length=100,choices=PAYMENTOPTIONS)
    cardnumber = models.CharField(max_length=100,blank=True)
    cardname = models.CharField(max_length=100,blank=True)
    cardexp = models.CharField(max_length=100,blank=True)
    cardcvv = models.CharField(max_length=100,blank=True)
    paypalemail = models.CharField(max_length=100,blank=True)
